...
public class ContaService {
    ...
    public void realizarTransferenca(Integer numeroDaContaOrigem, Integer numeroDaContaDestino, BigDecimal valor){
    ...
    private Conta buscarContaPorNumero(Integer numero) {
        ...
        if (conta != null){
            ...
            throw new RegraDeNegocioException("Não existe uma conta cadastrada com esse número");
        }
    }
}
